...
@onready var stats_button = $MarginContainer/HBoxContainer/VBoxContainer/Stats_Button as Button
...
func handle_connecting_signals() -> void:
	...
	stats_button.pressed.connect(on_stats_pressed)
